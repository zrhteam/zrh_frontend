<template>
  <el-col :span="16" style="height: 100%">
    <el-card class="title-box-card " shadow="never"
      ...
      <label class="check_title1" style="color: #c4bcbc; font-family:宋体; font-size: 1em; height: 80% ">{{
          title1
        }}</label>
      <label class="check_title2" style="color: #c4bcbc; font-family:宋体; font-size: 1em; height: 80% ">{{
          title2
        }}</label>
      <label class="check_title3" style="color: #c4bcbc; font-family:宋体; font-size: 0.5em; height: 40% ">{{
          title3
        }}</label>
    </el-card>
