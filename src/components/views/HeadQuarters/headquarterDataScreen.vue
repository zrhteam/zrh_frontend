...
<!--          &lt;!&ndash;         <el-tab-pane label="授权页面" name="second" :key=" 'second' " lazy>&ndash;&gt;-->
...
<!--&lt;!&ndash;        <Ratio&ndash;&gt;-->
<!--&lt;!&ndash;            :context="{&ndash;&gt;-->
<!--&lt;!&ndash;          title:'不同专业隐患数量',&ndash;&gt;-->
<!--&lt;!&ndash;          id: 'id_head_major',&ndash;&gt;-->
<!--&lt;!&ndash;        }"></Ratio>&ndash;&gt;-->
<!--      </el-col>-->
...
<!--&lt;!&ndash;          id: 'id_head_region'&ndash;&gt;-->
<!--&lt;!&ndash;        }"></Ratio>&ndash;&gt;-->
<!--      </el-col>-->
<!--      <el-col :span="8" style="height: 48%; margin-top: 1%">-->
<!--&lt;!&ndash;        <BarRank&ndash;&gt;-->
<!--&lt;!&ndash;            :context="{&ndash;&gt;-->
<!--&lt;!&ndash;          title:'各区域检查次数',&ndash;&gt;-->
<!--&lt;!&ndash;          id: 'id_head_rank1'}"&ndash;&gt;-->
<!--&lt;!&ndash;        ></BarRank>&ndash;&gt;-->
<!--      </el-col>-->
<!--      <el-col :span="8" style="height: 48%; margin-top: 1%">-->
<!--&lt;!&ndash;        <BarRank&ndash;&gt;-->
<!--&lt;!&ndash;            :context="{&ndash;&gt;-->
<!--&lt;!&ndash;          title:'各区域在管项目数量',&ndash;&gt;-->
<!--&lt;!&ndash;          id: 'id_head_rank2'}"&ndash;&gt;-->
<!--&lt;!&ndash;        ></BarRank>&ndash;&gt;-->
<!--      </el-col>-->
<!--      <el-col :span="8" style="height: 48%; margin-top: 1%">-->
