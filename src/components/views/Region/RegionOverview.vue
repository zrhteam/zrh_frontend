<template>
  ...
  <el-row style="height: 100%;">
    <el-row id="region" style="height: 100%;">
      <RegionDataScreen id="region_small" v-if="showDataScreen" @outRegionDataScreen="outRegionDataScreen"></RegionDataScreen>
...
<!--          </el-card>-->
          <div class="title-box-card " shadow="never"
            ...
            <el-col :span="16" style="height: 100%;">
              <h4>
                <span id="region_title1"
                      style="color: #c4bcbc; font-family:Microsoft YaHei; font-size: 0.6em; font-weight: bold;vertical-align: 45%; height: 100%; width: 100% ;text-align: center">{{ title1 }}</span>
                <span id="region_title2"
                      style="color: #c4bcbc; font-family:Microsoft YaHei; font-size: 0.6em; font-weight: bold;vertical-align: 45%; height: 100%; width: 100% ;text-align: center">{{ title2 }}</span>
              </h4>
            </el-col>
      ...
      <el-row id="region_large2" v-if="!showDataScreen" class="" style="height:86%;">
        ...
        <el-col :span="22" class="main-pane">
          <el-row class="el-row" :gutter="10" type="flex" justify="space-between"
            ...
            <el-col :span="7" style="height: 100%; width: 100%;">
              <BarRank :context="{title: '各区域检查次数', id: 'id_head_rank1'}"></BarRank>
            </el-col>
            <el-col :span="7" style="height: 100%; width: 100%;">
              <BarRank :context="{title:'累积高风险数量区域排名', id: 'id_head_rank1'}"></BarRank>
            </el-col>
          </el-row>
          ...
          <el-row class="el-row" :gutter="10" type="flex" justify="space-between"
            ...
            <el-col :span="7" style="height: 100%; width: 100%;">
              <BarRank :context="{title:'不同专业隐患数量', id: 'id_head_rank1'}"></BarRank>
            </el-col>
            <el-col :span="7" style="height: 100%; width: 100%;">
              <BarRank :context="{title:'不同分布区域隐患数量', id: 'id_head_rank1'}"></BarRank>
            </el-col>
            <el-col :span="7" style="height: 100%; width: 100%;">
              <BarRank :context="{title:'不同子系统隐患数量', id: 'id_head_rank1'}"></BarRank>
            </el-col>
          </el-row>
          ...
          <el-row class="el-row" :gutter="10" type="flex" justify="space-between"
            ...
            <el-col :span="11" style="height: 100%; width: 100%;">
              <BarRank :context="{title:'不同致因阶段隐患数量', id: 'id_head_rank1'}"></BarRank>
            </el-col>
            <el-col :span="11" style="height: 100%; width: 100%;">
              <BarRank :context="{title:'不同风险等级隐患数量', id: 'id_head_rank1'}"></BarRank>
            </el-col>
          </el-row>
        </el-col>
