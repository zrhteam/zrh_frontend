        ...
        <el-row style="height: 32%" class="boundary-A">
          <div
            ...
            <div class="counter-container">
              <span class="prefix">累计</span>
              <!--            写一个循环的number-->
              <div id="real-number">
              </div>
              <span class="suffix">例</span>
            </div>
          </div>
          <div
            ...
            <div class="counter-container">
              <span class="numbers" style="color:rgb(255, 10, 10);">12</span>
              <span class="suffix">例</span>
            </div>
          </div>
          <div
            ...
            <div class="counter-container">
              <span class="numbers" style="color:rgb(255, 139, 0);">12</span>
              <span class="suffix">例</span>
            </div>
          </div>
          <div
            ...
            <div class="counter-container">
              <span class="numbers" style="color: rgb(10, 166, 255);">12</span>
              <span class="suffix">例</span>
            </div>
          </div>
        </el-row>
          ...
          <div
            ...
            <div class="major-card">
              ...
              <div
                ...
                <div
                    style="width: 92px; height: 43px; pointer-events: auto; display: block; align-items: start; flex-direction: column; --prefix-num-margin-right:0px; --num-suffix-margin-left:6px;">
