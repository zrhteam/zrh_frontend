  ...
  <div class="check_screen" style="height: 100%">
    <el-row style="height: 10%" class="boundary-A">
      ...
      <div
        ...
        <div class="title" style="width: 8.75rem; height: 100%;">检查实时隐患监控大屏</div>
      </div>
      <div
      ...
      <div style="position: absolute !important; width: 6.8rem; height: 0.7rem; left: 23.1rem; top: 40%;">
        <el-button class="title" round size="mini" @click="quitCheckScreen" style="z-index: 999;top: 40%">退出</el-button>
      </div>
      <!--      </el-col>-->
    </el-row>
